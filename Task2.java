...
public class Task2 {
	...
	public static void main(String[] args)   //Main Method. The execution starts from this method
	{
		...
		String accname = "Atharva khopade";    //Declaring the account details
		String branchname = "Aurangabad";
		String branchaddress = "LK-09,west,Aurangabad";
		String branchIFSC = "SBI2879";
